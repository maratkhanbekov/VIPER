...
class SearchSongViewController: UIViewController {
    ...
    let presenter: SearchSongViewOutput
...
//        let appDetaillViewController = SongDetailViewController(app: song)
//        appDetaillViewController.app = app
        
        presenter.viewDidSelectApp(song: song)
